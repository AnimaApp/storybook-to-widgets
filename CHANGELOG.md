# v1.0.23 (Sun Oct 30 2022)

#### 🐛 Bug Fix

- Feat/mantine UI [#37](https://github.com/AnimaApp/storybook-to-widgets/pull/37) ([@besartmarku](https://github.com/besartmarku) 34649952+besartmarku@users.noreply.github.com [@andrefgneves](https://github.com/andrefgneves))
- Mui use layers [#39](https://github.com/AnimaApp/storybook-to-widgets/pull/39) (haimonline@gmail.com [@Haimonline](https://github.com/Haimonline))
- fix missing dependency [#38](https://github.com/AnimaApp/storybook-to-widgets/pull/38) ([@andrefgneves](https://github.com/andrefgneves))
- feat: add script to take component screenshots and upload them to s3 [#36](https://github.com/AnimaApp/storybook-to-widgets/pull/36) ([@andrefgneves](https://github.com/andrefgneves))
...
- package lock update ([@adinu](https://github.com/adinu))
