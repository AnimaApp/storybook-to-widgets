import { StoryContext, PartialStoryFn } from "@storybook/addons";
import { useEffect, useGlobals } from "@storybook/addons";

export const withGlobals = (storyFn: PartialStoryFn, context: StoryContext) => {
  const [{ packageJson }] = useGlobals();
